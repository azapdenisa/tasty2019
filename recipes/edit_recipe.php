...
<div class="w3-top">
        <div class="w3-bar w3-white w3-card" id="myNavbar">
          ...
          <div class="w3-right w3-hide-small">
            ...
            <a href="recipes.php" class="w3-bar-item w3-button"><i class="fas fa-utensils"></i> RECIPES</a>
      ...
      <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
        ...
        <a href="recipes.php" onclick="w3_close()" class="w3-bar-item w3-button">RECIPES</a>
...
<div class="header panel-style">
	...
	<form method="post" action='edit_recipe_query.php' class="panel-style">
